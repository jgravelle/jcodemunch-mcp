...
src/jcodemunch_mcp/
  ...
  summarizer/
    batch_summarize.py # 3-tier: Anthropic > Gemini > OpenAI-compat > MiniMax > GLM > OpenRouter > OrcaRouter > signature fallback
  tools/
...
| `JCODEMUNCH_SUMMARIZER_PROVIDER` | — | Explicit summarizer provider: `anthropic`, `gemini`, `openai`, `minimax`, `glm`, `openrouter`, `orcarouter`, `none` |
...
| `ORCAROUTER_API_KEY` | — | Enables OrcaRouter summaries (default model: `openai/gpt-4o-mini`) |
