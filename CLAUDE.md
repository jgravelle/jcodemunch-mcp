...
⚠ **jFlowMunch:** a proposal touching more than one control-flow step writes
`.jFlowMunch/current.json` before approval; schema:
`C:\MCPs\jflowmunch\agent\jflowmunch-instructions.md`.
