...
_README = [
    ...
    "one channel of several: constant_patterns, container_node_types, and literals",
    "matched inside the extractor itself all reach it -- so go/const_declaration,",
    "javascript/lexical_declaration and rust/const_item DO yield symbols,",
    "rust/impl_item is a container that deliberately emits none, and cpp matches",
    "namespace_definition literally. The entry means: nothing in the node-type map",
